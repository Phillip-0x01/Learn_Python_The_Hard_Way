"""
Create a game similar to ex35.py that follows these 5 rules:

1: Every if-statement must have an else
2: If this else should never run because it doesn't make sense, then you must use a die function in the else
